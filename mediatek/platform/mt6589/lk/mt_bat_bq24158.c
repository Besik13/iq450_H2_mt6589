...
#define bq24158_AC_CHARGING_CURRENT_750  //line wangyanhui add
...
//Ivan     
    bq24158_hw_init();
	 ...
	 printf("[mt65xx_bat_init] turn off charging begin  A----- add by yangyan \n");
        pchr_turn_off_charging_bq24158();			//modify by yangyan
    ...
    if ((upmu_is_chr_det() == KAL_TRUE))
    {
        ...
        bq24158_dump_register();            
        //pchr_turn_on_charging_bq24158();
        printf("[mt65xx_bat_init] turn off charging begin  B----- add by yangyan \n");
        pchr_turn_off_charging_bq24158();			//modify by yangyan
        printf("[mt65xx_bat_init] turn off charging end  B----- add by yangyan \n");
    }
