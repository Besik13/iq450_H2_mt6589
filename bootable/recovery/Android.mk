...
# hufeng.mao@generalmobi.com 2013-01-11 add for GMT FOTA
ifeq ($(GMT_FOTA_SUPPORT),yes)
	LOCAL_CFLAGS += -DGMT_RECOVERY_MODE_FOTA_SUPPORT
endif
...
ifeq ($(VOLTAGE_LIMIT_SUPPORT),yes)
LOCAL_CFLAGS += -DVOLTAGE_LIMIT_SUPPORT
endif
