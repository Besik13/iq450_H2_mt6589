...
//    printf("Ivan process_key: key_code=%d, updown=%d \n", key_code,updown);
    
    //Ivan accept only predefined keys
//    if (key_code != RECOVERY_KEY_ENTER && key_code != RECOVERY_KEY_MENU && key_code != RECOVERY_KEY_DOWN && key_code != RECOVERY_KEY_UP)
//	return;
