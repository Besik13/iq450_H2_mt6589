 ...
 *
 * \return	S_RB_SUCCESS on success, E_RB_OPENFILE_ONLYR if attmpeting to open a
 ...
 *******************************************************************************
 */
long RB_GetAvailableFreeSpace(void *pbUserData, const char *path, unsigned long *available_flash_size);
 ...
 *******************************************************************************
 */
long RB_Unlink(void *pbUserData, char *pLinkName);
 ...
 *******************************************************************************
 */
long RB_Link(void *pbUserData, char *pLinkName, char *pReferenceFileName);

/*!
 *******************************************************************************
 * Set file attributes.<p>
 *
 * The file attributes (\a ui8pAttribs) are sent as follows:
 ...
 * \param	ui32AttribSize	Size of \a ui8pAttribs (12 on Windows, 25 on Linux)
 * \param	ui8pAttribs		Attributes to set
 *
 * \return	S_RB_SUCCESS on success or &lt; 0 on error
 *******************************************************************************
 */
long RB_SetFileAttributes(void *pbUserData, const char *ui16pFilePath, const unsigned long ui32AttribSize, const unsigned char *ui8pAttribs);
